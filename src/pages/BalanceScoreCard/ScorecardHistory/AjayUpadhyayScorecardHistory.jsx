...
export const AjayUpadhyayScorecardHistory = () => {
...
const formatMonth = (monthString) => {
  ...
  try {
    ...
    if (typeof monthString === 'string' && monthString.match(/^[A-Za-z]+\s\d{4}$/)) {
      return monthString;
    }
    ...
    return (
      <div className="p-4">
        <div className="text-center">
          <div className="text-lg font-semibold mb-4">Ajay Upadhyay Scorecard History</div>
