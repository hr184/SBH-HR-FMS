...
useEffect(() => {
        ...
        if (data && data.data && data.data.length > 0) {
          ...
          if (userRows.length > 0) {
            ...
            setUserData({
              ...
              coordinatingCamps1: latestUserRow[8] || '',
              coordinatingCamps2: latestUserRow[9] || '',
              coordinatingCamps3: latestUserRow[10] || '',
              conductingCamps1: latestUserRow[11] || '',
              conductingCamps2: latestUserRow[12] || ''
            });
          } else {
  ...
  const calculateTotals = () => {
    const jobAssessmentTotal = Object.values(scores).slice(0, 9).reduce((a, b) => a + (parseFloat(b) || 0), 0);
    const behavioralTotal = Object.values(scores).slice(9).reduce((a, b) => a + (parseFloat(b) || 0), 0);
    const overallTotal = jobAssessmentTotal + behavioralTotal;
    
    // Calculate target totals (out of values)
    const jobAssessmentTargets = [10, 10, 9, 9, 9, 9, 8, 8, 8];
  ...
  scores.coordinatingCamps1 || 0,     // Column I (index 8)
  scores.coordinatingCamps2 || 0,     // Column J (index 9)
  scores.coordinatingCamps3 || 0,     // Column K (index 10)
  scores.conductingCamps1 || 0,       // Column L (index 11)
  scores.conductingCamps2 || 0,       // Column M (index 12)
  scores.qualityOfWork || 0,          // Column N (index 13)
  scores.planningExecution || 0,      // Column O (index 14)
  scores.timeResources || 0,          // Column P (index 15)
  scores.interpersonalRelations || 0, // Column Q (index 16)
  scores.flexibilityAdaptability || 0,// Column R (index 17)
  scores.communication || 0,          // Column S (index 18)
  scores.integrity || 0,              // Column T (index 19)
  scores.leadership || 0,             // Column U (index 20)
  scores.discipline || 0,             // Column V (index 21)
  scores.punctuality || 0             // Column W (index 22)
];
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', borderRadius: '8px', overflow: 'hidden' }}>
          ...
          <tbody>
            ...
            <tr style={{ backgroundColor: '#f8fafc' }}>
              <td rowSpan={2} style={{ padding: '12px', border: '1px solid #e2e8f0', fontFamily: 'Poppins Regular', fontWeight: 'bold', backgroundColor: '#eff6ff' }}>Visit Target</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Ensuring 50 new patients a month to the unit 
</td>
            ...
            <tr style={{ backgroundColor: '#ffffff' }}>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Getting atlest 2 IVF/ICSI bilings done a month</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', fontWeight: 'bold' }}>10</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', color: '#666' }}>
            ...
            <td rowSpan="2" style={{ padding: '12px', border: '1px solid #e2e8f0', fontFamily: 'Poppins Regular', fontWeight: 'bold', backgroundColor: '#eff6ff', verticalAlign: 'top' }}>Revenue & Generating Business Target Achieved	</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Generating a busines through HIUI/DIUI, DFI, SEMEN Analysis etc….</td>
            ...
            <tr style={{ backgroundColor: '#ffffff' }}>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Achive a target of min 5 Lacs a month ( Inclusive of OPD,  IVF,ICSI, HIUI, DIUI.DFI  other services)</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', fontWeight: 'bold' }}>9</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', color: '#666' }}>
