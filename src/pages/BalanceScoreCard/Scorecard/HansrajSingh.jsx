        ...
        <table border="1" cellPadding="8" cellSpacing="0" style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td rowSpan="2" style={{ borderRight: '2px solid #000' }}><strong>Expenses</strong></td>
              <td>Tracking the monthly budget vs expenses of HK department</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Tracking the pending payments of vendor and complete it within the TAT</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            {/* Checking KRA */}
            <tr style={{ border: '2px solid #000' }}>
            <td rowSpan="1" style={{ borderRight: '2px solid #000' }}><strong>Checking</strong></td>
              <td>Timely collect & checking the bills of vendor and submit to store and accounts department</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
            <td rowSpan="3" style={{ borderRight: '2px solid #000' }}><strong>Patient Satisfaction</strong></td>
              <td>Cleaning the patient rooms properly as per the cleaning checklist</td>
              <td>6</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Ensure for the room service as per the patient call bell</td>
              <td>5</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              ...
              <td>Counselling the staff as per the need</td>
              <td>2</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Monthly wise staff mobilization, Duty alertment</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            {/* Operational KRA */}
            <tr style={{ border: '2px solid #000' }}>
              <td rowSpan="8" style={{ borderRight: '2px solid #000' }}><strong>Operational</strong></td>
              <td>Maintain the BMW checklist on daily basis</td>
              <td>4</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Maintain the waste segregation as per the BMW act</td>
              <td>4</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Maintain the STP and ETP Management as per the pollution control act</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Control the spill management within the TAT</td>
              <td>5</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Follow the checklist of Daily, Weekly and Monthly cleaning floor wise</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Checking of MGPS on daily and weekly basis with record keeping</td>
              <td>5</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Maintain the hygienic and ecofriendly atmosphere within the building</td>
              <td>2</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Tracking of AMC and CMC of departmental machineries on periodically</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
            <td rowSpan="1" style={{ borderRight: '2px solid #000' }}><strong>Reports</strong></td>
            ...
            <td rowSpan="2" style={{ borderRight: '2px solid #000' }}><strong>Training & Development</strong></td>
              <td>Impart per month (6 hr) Training to subordinates regarding new policies, Cleaning method, Fire Mock Drill and Emergency codes</td>
              <td>8</td>
              <td>
                <input 
                  type="number" 
