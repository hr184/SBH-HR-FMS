...
export const PratimaVarthi = () => {
  ...
  const parseJobScores = (row) => {
    if (!row) return {};
    return {
      purchaseTracking: row[4] || "",
      processAudit: row[5] || "",
      process1: row[6] || "",
      process2: row[7] || "",
      process3: row[8] || "",
      process4: row[9] || "",
      riskManagement1: row[10] || "",
      riskManagement2: row[11] || "",
      budgetCostControl1: row[12] || "",
      budgetCostControl2: row[13] || "",
      budgetCostControl3: row[14] || "",
      inventoryManagement1: row[15] || "",
      inventoryManagement2: row[16] || "",
      processImprovement1: row[17] || "",
      processImprovement2: row[18] || "",
      complianceEthics1: row[19] || "",
      complianceEthics2: row[20] || "",
      contractManagement: row[21] || "",
    };
  };
  ...
  const applyMonthData = (targetMonth, rows) => {
    ...
    if (cooRow) {
      setScores({
        ...
        qualityOfWork: cooRow[22] || '',
        planningExecution: cooRow[23] || '',
        timeResources: cooRow[24] || '',
        interpersonalRelations: cooRow[25] || '',
        flexibilityAdaptability: cooRow[26] || '',
        communication: cooRow[27] || '',
        integrity: cooRow[28] || '',
        leadership: cooRow[29] || '',
        discipline: cooRow[30] || '',
        punctuality: cooRow[31] || ''
      });
    } else {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const rowData = [
        ...
        evaluatorName,
        "",
        scores.purchaseTracking || 0,
        scores.processAudit || 0,
        scores.process1 || 0,
        scores.process2 || 0,
        scores.process3 || 0,
        scores.process4 || 0,
        ...
        scores.budgetCostControl1 || 0,
        scores.budgetCostControl2 || 0,
        scores.budgetCostControl3 || 0,
        scores.inventoryManagement1 || 0,
        scores.inventoryManagement2 || 0,
        scores.processImprovement1 || 0,
        scores.processImprovement2 || 0,
        scores.complianceEthics1 || 0,
        scores.complianceEthics2 || 0,
        scores.contractManagement || 0,
