  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const rowData = [
        ...
        scores.pptFollowUp || 0, // Column P (index-15)
        scores.allComplince || 0, // Column Q (index-16)
        scores.procedureRegisterVerification || 0, // Column R (index-17)
        scores.ratingSheet || 0, // Column S (index-18)
        scores.discountAndCorrection1 || 0, // Column T (index-19)
        scores.discountAndCorrection2 || 0, // Column T (index-19)
        scores.discountAndCorrection3 || 0, // Column T (index-19)
        scores.discountAndCorrection4 || 0, // Column T (index-19)
        scores.discountAndCorrection5 || 0, // Column T (index-19)
        scores.discountAndCorrection6 || 0, // Column T (index-19)
        // scores.otherWork || 0, // Column U (index-20)
        // scores.appointmentScheduling || 0, // Column V (index-21)
        scores.directorsRecidancy || 0, // Column W (index-22)
        scores.dailyRevanueDataShare || 0, // Column X (index-23)
        // scores.meetingSchedule || 0, // Column Y (index-24)
    ...
    <ToastContainer />
      ...
      {/* PPT Follow Up KRA */}
            ...
            <tr style={{ backgroundColor: '#ffffff' }}>
             ...
             {/* Other Work KRA */}
            {/* <tr style={{ backgroundColor: '#ffffff' }}>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', fontFamily: 'Poppins Regular', fontWeight: 'bold', backgroundColor: '#eff6ff', verticalAlign: 'top' }}>Other Work</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Time To Time Assign by seniors & Directors</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', fontWeight: 'bold' }}>2</td>
              <td style={{ padding: '8px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
                <input 
                  type="number" 
                  value={scores.otherWork}
                  onChange={(e) => handleScoreChange('otherWork', e.target.value)}
                  style={{ width: '80px', padding: '6px', border: '1px solid #cbd5e1', borderRadius: '4px', textAlign: 'center' }}
                  placeholder="0-2"
                  min="0"
                  max="2"
             ...
             {/* Appointment Scheduling KRA */}
            {/* <tr style={{ backgroundColor: '#ffffff' }}>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', fontFamily: 'Poppins Regular', fontWeight: 'bold', backgroundColor: '#eff6ff', verticalAlign: 'top' }}>Appointment Scheduling</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>Daily, Weekly Scheduling of Directors</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', fontWeight: 'bold' }}>3</td>
              <td style={{ padding: '8px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
                <input 
                  type="number" 
            ...
            <tr style={{ backgroundColor: '#ffffff' }}>
             ...
             {/* Meeting's Schedule KRA */}
            {/* <tr style={{ backgroundColor: '#ffffff' }}>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', fontFamily: 'Poppins Regular', fontWeight: 'bold', backgroundColor: '#eff6ff', verticalAlign: 'top' }}>Meeting's Schedule</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0' }}>schedule and coordinate all meetings involving the Directors, CEO, COO and VP Sir.</td>
              <td style={{ padding: '12px', border: '1px solid #e2e8f0', textAlign: 'center', fontWeight: 'bold' }}>2</td>
              <td style={{ padding: '8px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
                <input 
                  type="number" 
                  value={scores.meetingSchedule}
                  onChange={(e) => handleScoreChange('meetingSchedule', e.target.value)}
                  style={{ width: '80px', padding: '6px', border: '1px solid #cbd5e1', borderRadius: '4px', textAlign: 'center' }}
                  placeholder="0-2"
                  min="0"
                  max="2"
