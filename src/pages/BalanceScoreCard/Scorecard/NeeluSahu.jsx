...
export const NeeluSahu = () => {
  ...
  const parseJobScores = (row) => {
    if (!row) return {};
    return {
      patientsExperience1: row[4] || "",
      patientsExperience2: row[5] || "",
      patientsExperience3: row[6] || "",
      patientsExperience4: row[7] || "",
      patientsExperience5: row[8] || "",
      patientsExperience6: row[9] || "",
      nps1: row[10] || "",
      nps2: row[11] || "",
      nps3: row[12] || "",
      nps4: row[13] || "",
