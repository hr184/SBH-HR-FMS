...
export const UmeshDhakkad = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert('Scores submitted successfully! Data has been stored in Google Sheets.');
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <table border="1" cellPadding="8" cellSpacing="0" style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Meeting with Doctors on weekly basis to increase the number of prescriptions</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>To increase sales turnover by 15% for OPD</td>
              <td>7</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              ...
              <td>To receive requisition and issue the material on time to IP Department</td>
              <td>5</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
            <td rowSpan="3" style={{ borderRight: '2px solid #000' }}><strong>External Customer Satisfaction</strong></td>
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>To issue the Purchase Order to vender and get the qualitative material from the vendor within time frame</td>
              <td>5</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              ...
              <td>100% Track the near expiry medicine quarterly basis & return to vendor</td>
              <td>8</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Physical verification of medicine received from Vendor & after verification have to give receiving</td>
              <td>2</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>Have to track Vendor's ourstanding and make sure the payment clearance within TAT</td>
              <td>7</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              <td>To check & maintain statutory documents periodically</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
            ...
            <tr style={{ border: '2px solid #000' }}>
              ...
              <td>100% adherence to timeline for submission of MIS reports to management and ensure timely update reports by subordinates</td>
              <td>3</td>
              <td>
                <input 
                  type="number" 
