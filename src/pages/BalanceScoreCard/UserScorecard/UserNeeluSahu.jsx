...
export const UserNeeluSahu = () => {
  ...
  const parseScoresFromRow = (row) => {
    return {
      petientsExperience1: row[4] !== undefined && row[4] !== "" ? row[4] : "",
      petientsExperience2: row[5] !== undefined && row[5] !== "" ? row[5] : "",
      petientsExperience3: row[6] !== undefined && row[6] !== "" ? row[6] : "",
      petientsExperience4: row[7] !== undefined && row[7] !== "" ? row[7] : "",
      petientsExperience5: row[8] !== undefined && row[8] !== "" ? row[8] : "",
      petientsExperience6: row[9] !== undefined && row[9] !== "" ? row[9] : "",
      ...
      nps5: row[14] !== undefined && row[14] !== "" ? row[14] : "",
      nps6: row[15] !== undefined && row[15] !== "" ? row[15] : "",
      other1: row[16] !== undefined && row[16] !== "" ? row[16] : "",
      other2: row[17] !== undefined && row[17] !== "" ? row[17] : "",
      other3: row[18] !== undefined && row[18] !== "" ? row[18] : "",
      other4: row[19] !== undefined && row[19] !== "" ? row[19] : "",
    };
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const rowData = [
        ...
        employeeName,
        "",
        scores.petientsExperience1 || 0,
        scores.petientsExperience2 || 0,
        scores.petientsExperience3 || 0,
        scores.petientsExperience4 || 0,
        scores.petientsExperience5 || 0,
        scores.petientsExperience6 || 0,
        scores.nps1 || 0,
        scores.nps2 || 0,
        scores.nps3 || 0,
        scores.nps4 || 0,
