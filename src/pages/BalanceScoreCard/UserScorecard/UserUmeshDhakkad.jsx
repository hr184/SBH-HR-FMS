...
export const UserUmeshDhakkad = () => {
  ...
  const parseScoresFromRow = (row) => {
    return {
      consumptionCostReduction: row[4] !== undefined && row[4] !== "" ? row[4] : "",
      budgetCompliance: row[5] !== undefined && row[5] !== "" ? row[5] : "",
      doctorMeetings: row[6] !== undefined && row[6] !== "" ? row[6] : "",
      salesTurnoverIncrease: row[7] !== undefined && row[7] !== "" ? row[7] : "",
      materialIssuance: row[8] !== undefined && row[8] !== "" ? row[8] : "",
      vendorQuotations: row[9] !== undefined && row[9] !== "" ? row[9] : "",
      purchaseOrderManagement: row[10] !== undefined && row[10] !== "" ? row[10] : "",
      patientFeedback: row[11] !== undefined && row[11] !== "" ? row[11] : "",
      sopAuditScore: row[12] !== undefined && row[12] !== "" ? row[12] : "",
      nearExpiryTracking: row[13] !== undefined && row[13] !== "" ? row[13] : "",
      consumptionStockReport: row[14] !== undefined && row[14] !== "" ? row[14] : "",
      grnRegister: row[15] !== undefined && row[15] !== "" ? row[15] : "",
      physicalVerification: row[16] !== undefined && row[16] !== "" ? row[16] : "",
      manpowerManagement: row[17] !== undefined && row[17] !== "" ? row[17] : "",
      vendorOutstanding: row[18] !== undefined && row[18] !== "" ? row[18] : "",
      invoiceVerification: row[19] !== undefined && row[19] !== "" ? row[19] : "",
      statutoryDocuments: row[20] !== undefined && row[20] !== "" ? row[20] : "",
      misReports: row[21] !== undefined && row[21] !== "" ? row[21] : "",
