...
export function UserHarshRai() {
  ...
  const parseScoresFromRow = (row) => {
    return {
      ...
      coordinatingCamps1: row[8] !== undefined && row[8] !== "" ? row[8] : "",
      coordinatingCamps2: row[9] !== undefined && row[9] !== "" ? row[9] : "",
      coordinatingCamps3: row[10] !== undefined && row[10] !== "" ? row[10] : "",
      conductingCamps1: row[11] !== undefined && row[11] !== "" ? row[11] : "",
      conductingCamps2: row[12] !== undefined && row[12] !== "" ? row[12] : "",
    };
  };
