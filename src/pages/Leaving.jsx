...
const fetchJoiningData = async () => {
  ...
  try {
    const response = await fetch(
      'https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec?sheet=JOINING&action=fetch'
    );
  ...
  const fetchLeavingData = async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec?sheet=LEAVING&action=fetch'
      );
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const updateJoiningResponse = await fetch('https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec', {
      method: 'POST',
    ...
    const updateReasonResponse = await fetch('https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec', {
      method: 'POST',
    ...
    const insertResponse = await fetch('https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec', {
      method: 'POST',
      body: insertParams,
    });
