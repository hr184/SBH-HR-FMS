  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec?sheet=Report&action=fetch'
      );
...
const getIndex = (headerName) => {
 ...
 const downloadDailyData = async (empId, name, month) => {
    ...
    try {
      const response = await fetch(
        `https://script.google.com/macros/s/AKfycbw6xeabQpVzEnNMhLWfMAwLJ0hFZxA2L89aX17-p4b-caM4SdpsETrtq5GT4Lwk84qL/exec?sheet=Report Daily&action=fetch`
      );
